...
public class WebTestConfig {
	...
	//테스트 대상 클래스 : LoginController   
		//					--> MemberService
		//						--> MemberRepository
		//LoginController 스프링 빈을 생성하기 위해서는 MemberService, MemberRepository 스프링 빈이필요
		...
		//4. 응답이 원하는 형태로 나오는지 체크(viewName, model에담긴속성)
		@Autowired
		protected WebApplicationContext context;
		
		protected MockMvc mockMvc; // dispatcher servlet열할
