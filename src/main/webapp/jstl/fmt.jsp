...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#lang').on('change', function() {
			...
			document.location="/jstl/fmt.jsp?lang=" + $('#lang').val();
			
			console.log('#lang change:' + '/jstl/fmt.jsp?lang='+ $('#lang').val());
...
<body>
	<%-- 1. jquery 라이브러리 추가
		 ...
		 3. 페이지가 로딩이 되었을때 사용자가 요청한 언어로 option태그가 선택 된 상태로 표현
		 4. 만약에 사용자가 언어 설정 파라미터를 보내지 않았을 경우 기본값으로 한국어로 표현
		 5. option태그가 바뀌면 자동으로 jsp_fmt.jsp로 재요청
	 --%>
	<!-- locale 정보를 변경 -->
